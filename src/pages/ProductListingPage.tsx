                  ...
                  >
                    <Link to={`/product/${product.id}`} className="relative h-64 overflow-hidden bg-white flex items-center justify-center">
                      ...
                      {product.discountPrice && (
                        <span className="absolute top-4 left-4 bg-orange-600 text-white text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest z-10">Sale</span>
                      )}
                      {product.specialOffer && (
                        <span className="absolute top-4 right-4 bg-yellow-400 text-gray-900 text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest z-10 shadow-lg animate-bounce">
                          {product.specialOffer}
                        </span>
                      )}
